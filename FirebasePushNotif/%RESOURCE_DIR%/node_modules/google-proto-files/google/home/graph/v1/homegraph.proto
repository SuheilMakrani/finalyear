...
service HomeGraphApiService {
  ...
  // Reports device state and optionally sends device postNotifications. Called by
...
// Sample ReportStateAndNotificationRequest, with states and postNotifications
...
message ReportStateAndNotificationDevice {
  ...
  google.protobuf.Struct postNotifications = 2;
}
