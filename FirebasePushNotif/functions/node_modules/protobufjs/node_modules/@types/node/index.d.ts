...
declare module "perf_hooks" {
    ...
    export class PerformanceObserver extends AsyncResource {
        ...
        /**
         * Disconnects the PerformanceObserver instance from all postNotifications.
         */
        disconnect(): void;

        /**
         * Subscribes the PerformanceObserver instance to postNotifications of new PerformanceEntry instances identified by options.entryTypes.
