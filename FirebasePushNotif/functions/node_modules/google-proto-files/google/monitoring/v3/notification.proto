...
message NotificationChannel {
  ...
  enum VerificationStatus {
    ...
    // It has been proven that postNotifications can be received on this
  ...
  // Whether postNotifications are forwarded to the described channel. This makes
  // it possible to disable delivery of postNotifications to a particular channel
  // without removing the channel from all alerting policies that reference
  // the channel. This is a more convenient approach when the change is
  // temporary and you want to receive postNotifications from the same set
