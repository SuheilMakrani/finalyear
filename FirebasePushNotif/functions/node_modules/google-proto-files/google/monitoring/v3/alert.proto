...
message AlertPolicy {
  ...
  message Condition {
    ...
    // postNotifications, and incidents. To avoid confusion, don't use the same
  ...
  // Documentation that is included with postNotifications and incidents related to
  ...
  // Identifies the notification channels to which postNotifications should be sent
